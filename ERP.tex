...
\begin{figure}
	\includegraphics[width=1.20\textwidth]{EsquemaOperacion_Crear.png}
	\caption{}
	\label{fig:OpCrear}
\end{figure}

\begin{figure}
	\includegraphics[width=1.20\textwidth]{EsquemaOperacion_Consultar.png}
	\caption{}
	\label{fig:OpConsultar}
\end{figure}

\begin{figure}
	\includegraphics[width=1.20\textwidth]{EsquemaOperacion_Modificar.png}
	\caption{}
	\label{fig:OpModificar}
\end{figure}

\begin{figure}
	\includegraphics[width=1.20\textwidth]{EsquemaOperacion_Borrar.png}
	\caption{}
	\label{fig:OpBorrar}
\end{figure}
